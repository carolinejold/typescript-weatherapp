...
export const App: React.FC<AppProps> = () => {
        ...
        async function fetchData() {
            if (userInputData[0] !== undefined) {
                let response = await axios(
                    `http://api.openweathermap.org/data/2.5/weather?q=${userInputData}&appid=ef9e479b1c45f1cb5b2c66bd14fbece9`,
                );
    ...
    return (
        <div>
            ...
            <WeatherResults userInputData={userInputData} tempData={tempData} weatherData={weatherData} />
        </div>
    );
};
